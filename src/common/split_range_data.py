...
OLD_DATASET_DIR = "dataset_ooi"


class DatasetSplitter:
    """Splits a dataset into train/validation sets from a range-based source."""

    def __init__(self, use_case: str):
        self.use_case = use_case

    def split(self, img_path, label_path, mask_path, master_json, dataset_old=None):
        ...
        root_path = f"data/{self.use_case}/{dataset_old}"
